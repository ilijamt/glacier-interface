...
public class CommandMultipartUploadInfo extends GenericCommand {
    ...
    @Parameter(names = "--vault", description = "The name of the vault from which the multipart upload info will be retrieved, will be overwritten by --aws-vault if not specified")
