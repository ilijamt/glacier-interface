...
public class CommandUploadArchive extends GenericCommand {
  ...
  @Parameter(required = true, names = "--file",
      description = "The file(s) to be uploaded, you can specify this parameter multiple times")
  ...
  @Parameter(
      names = "--force-upload",
      description = "Force upload if it exist in the journal, but it will still keep the old archive, you will have to delete the old one on your own")
