 ...
 *
 * @param <T> It's either {@link MultipartUploadStatus} or {@link MultipartDownloadStatus}
...
public class AbstractWritablePojo<T> {
     ...
     *
     * @param file The file we check if it exists and if it's a file
     ...
     * @param cls  The POJO class that is in the file
     * @return The POJO class
     * @throws IOException            If we cannot read from the file
     * @throws InstantiationException Invalid POJO class
     * @throws IllegalAccessException Invalid POJO class
     ...
     *
     * @param file The file that we use for writing or reading
     */
     ...
     * @throws NullPointerException No file defined
     */
     ...
     * Write the status to file.
     *
     * @param file The file to which we write
     * @return true if the write was succesufull, false otherwise
     * @throws IOException          Cannot write to the file
     * @throws NullPointerException No file defined
     */
