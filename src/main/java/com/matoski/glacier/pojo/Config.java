...
public class Config {
     ...
     *
     * @param arguments The arguments from which to generate {@link Config}
     ...
     *
     * @param filename The file name from where to read the {@link Config} object
     * @return The configuration object
     * @throws JsonSyntaxException   Invalid JSON format
     * @throws FileNotFoundException If the file cannot be found
     * @throws IOException           If the file cannot be read, or an error occurs during reading
     */
     ...
     *
     * @param json The json string from which we create {@link Config} object
     ...
     *
     * @param filename Which filename to save the configuration to
     ...
     *
     * @param arguments The arguments supplied by the command line, this is used to merge the arguments from a
     ...
     *
     * @param vault Is the vault required
     * @return true if the configuration is valid and has all required parameters to run
     */
