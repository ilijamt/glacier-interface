 ...
 * archive.
 *
 * @param <T> The class type, we can have seperate classes for Download/Upload, and add custom logic
 *            into it
...
public abstract class ArchiveState<T> extends AbstractWritablePojo<T> {
     ...
     *
     * @param part  Which part is this piece
     * @param piece The piece that was processed
     ...
     *
     * @param piece The piece that was processed
     * @throws IOException We cannot write the data to IO
     */
     ...
     *
     * @param finalChecksum the finalChecksum to set
     */
     ...
     * </p>
     *
     * @param remove Remove the state file if is finished?
     * @return true if the piece is finished
     */
     ...
     * </p>
     *
     * @param piece Piece to check if it exists
