...
public class MultipartUploadInfoCommand extends
	AbstractCommand<CommandMultipartUploadInfo> {

    public MultipartUploadInfoCommand(Config config,
	    CommandMultipartUploadInfo command)
	...
	ListPartsResult result = upload.GetMultipartUploadInfo(
		command.vaultName, command.multipartId);

	System.out.println(String.format("%1$20s: %2$s", "ID",
		result.getMultipartUploadId()));
