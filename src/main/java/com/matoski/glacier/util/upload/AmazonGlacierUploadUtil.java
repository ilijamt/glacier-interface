...
import com.matoski.glacier.enums.*;
...
public class AmazonGlacierUploadUtil extends AmazonGlacierBaseUtil {
    ...
    public AmazonGlacierUploadUtil(BasicAWSCredentials credentials, AmazonGlacierClient client,
                                   Region region) {
        super(credentials, client, region, Constants.DEFAULT_PROTOCOL);
    }
     ...
     * @param client      Amazon client
     * @param region      Amazon region
     * @param protocol    Amazon protocol
     */
    public AmazonGlacierUploadUtil(BasicAWSCredentials credentials, AmazonGlacierClient client,
                                   Region region, Protocol protocol) {
        super(credentials, client, region, protocol);
    }
     ...
     * @param secretKey Amazon secret key
     * @param region    Amazon region
     * @param protocol  The protocol used to connect to the Amazon Glacier servers
     * @throws RegionNotSupportedException Invalid or unsupported region
     */
     ...
     *
     * @param fileSize  The size of the upload
     * @param uploadId  The upload Id
     * @param vaultName Vault name
     * @param checksum  Upload checksum
     * @return Details about the request
     * @throws AmazonClientException  Amazon client exception
     * @throws AmazonServiceException Amazon service exception
     */
     ...
     *
     * @param vaultName          Vault name
     * @param archiveDescription Archive description
     * @param partSize           Archive part
     * @return Details about the request
     * @throws AmazonClientException  Amazon client exception
     * @throws AmazonServiceException Amazon service exception
     */
     ...
     * @param vaultName          To which vault to upload
     * @param archiveDescription Archive description
     * @param listener           Progress listener
     * @param collector          Metric collector
     * @return Details about the request
     * @throws FileNotFoundException  Upload file not found
     * @throws AmazonServiceException Amazon service exception
     * @throws AmazonClientException  Amazon client exception
     */
     ...
     * @param forceUpload       Force upload if the file exists in the journal
     * @param concurrent        How many threads should be used for upload
     * @param retryFailedUpload How many times to retry upload
     * @param partSize          Upload part size
     * @param replace           Replace the upload, if true it will delete the old archive
     * @return Details about the request
     */
     ...
     * @param partSize          Upload part size
     * @param replace           Replace the upload, if true it will delete the old archive
     * @param dryRun            Dry run, don't do anything just print out to console
     * @return Details about the request
     */
    public Archive uploadArchive(State journal, String vaultName, String fileName,
                                 Boolean forceUpload, int concurrent, int retryFailedUpload, int partSize, boolean replace,
     ...
     * @param file      A file representation of Filename
     ...
     * @throws UploadTooManyPartsException There are too many parts
     * @throws IOException                 IO Exception
     * @throws RegionNotSupportedException Invalid or unsupported region
     * @throws InstantiationException      Cannot load the state file
     * @throws IllegalAccessException      Invalid data in the state file
     */
        ...
        for (int i = 0; i < pieces; i++) {
            ...
            if (uploadStatus.isPieceCompleted(i)) {
                ...
                thread = new ThreadAmazonGlacierUploadUtil(retry, file, pieces, i, partSize, vaultName,
                        ...
                        region.getName(), this.getProtocol());
     ...
     * @param pieces    How many pieces there are for the upload
     * @param part      Current part that is uploaded
     * @param partSize  The part size for the upload
     * @param vaultName The vault name where to save the archive
     * @param uploadId  The upload ID
     * @return The details about the upload of the piece
     * @throws AmazonServiceException   Amazon service exception
     * @throws NoSuchAlgorithmException The cryptograhic algorithm doesn't exist
     * @throws AmazonClientException    Amazon client exception
     * @throws FileNotFoundException    File doesn't exists
     * @throws IOException              IO Exception
     * @throws InvalidChecksumException Invalid checksum during upload
     * @throws RequestTimeoutException  Timeout during request
     */
