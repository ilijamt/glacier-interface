...
public class AmazonGlacierDownloadUtil extends AmazonGlacierBaseUtil {
     ...
     * @param fileSize  Filename size
     * @param overwrite Overwrite the file
     * @return true if it creates an empty file
     * @throws FileAlreadyExistsException File already present in the system
     */
     ...
     * @throws FileAlreadyExistsException File already present in the system
     * @throws InvalidChecksumException   Downloaded file has wrong checksum
     */
     ...
     * Download a chunk.
     *
     * @param file      File that we need to download
     * @param vaultName Vault name
     * @param jobId     Job ID
     * @param part      Which part we are processing
     * @param partSize  Part size
     * @return Details about the request
