...
public class Parser {
     ...
     * Encode an archive.
     *
     * @param metadata The metadata to which we encode
     * @param archive  The archive we encode
     ...
     *
     * @param metadata The metadata for the parser
     * @return The parser
     */
     ...
     * Parse the data.
     *
     * @param metadata What is the metadata for the data
     * @param data     The data to parse
     * @return returns an object from which we can retrieve the data in the system
     * @throws InvalidMetadataException If invalid metadata
     * @throws NullPointerException     If the parser doesn't exist
     */
